...
class IndexFavoriteRequest extends ApiFormRequest
{
    /**
    ...
    {
        return [
            'type' => ['sometimes', 'string', Rule::in([...Favorite::types(), 'all'])],
            'status' => ['sometimes', 'string', Rule::in([...Favorite::statuses(), 'all'])],
