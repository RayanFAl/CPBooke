...
class OrderController extends Controller
{
    ...
    /**
     * Sync a flight booking from BookNow into Booke (idempotent by booking_id).
     */
    ...
    /**
     * Sync an eSIM purchase into Booke (idempotent by provider_booking.booking_id).
     */
    ...
    /**
     * Sync an insurance purchase into Booke (idempotent by provider_booking.booking_id).
     */
    ...
    /**
     * Sync a hotel booking into Booke (idempotent by provider_booking.booking_id).
     */
