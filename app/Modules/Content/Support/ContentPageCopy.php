...
<p>BookNow operates a travel marketplace application for flights, hotels, travel cover, and eSIM plans. This policy explains what personal data we collect, why we use it, and the rights you have. Last updated: 19 August 2026.</p>
<h2>1. Who we are</h2>
<p>When you create an account or complete a booking, BookNow is the controller of the personal data you provide through the app. Airlines, hotels, insurers, and connectivity providers act as independent controllers for the services they deliver.</p>
...
<li>Payment metadata: transaction references, wallet movements, and billing country. We do not store full card numbers on BookNow servers.</li>
...
<h2>8. Children</h2>
<p>BookNow accounts are intended for adults. Traveller details for minors may be added by a parent or guardian solely to complete a booking.</p>
...
<p>تشغّل BookNow تطبيقاً لحجز السفر يشمل الطيران والفنادق وتغطية السفر وباقات eSIM. توضّح هذه السياسة البيانات الشخصية التي نجمعها، وسبب استخدامها، وحقوقك. آخر تحديث: 19 أغسطس 2026.</p>
<h2>1. من نحن</h2>
<p>عند إنشاء حساب أو إتمام حجز، تكون BookNow الجهة المسؤولة عن البيانات التي تقدّمها عبر التطبيق. شركات الطيران والفنادق وشركات التأمين ومزوّدو الاتصال جهات مستقلة بالنسبة للخدمات التي تقدّمها.</p>
...
<li>بيانات الدفع: مراجع العمليات، حركة المحفظة، ودولة الفوترة. لا نخزّن أرقام البطاقات كاملة على خوادم BookNow.</li>
...
<h2>8. الأطفال</h2>
<p>حسابات BookNow مخصّصة للبالغين. يمكن لولي الأمر إضافة بيانات مسافر قاصر فقط لإتمام حجز.</p>
...
<p>These terms govern your use of the BookNow mobile application and website. By creating an account or placing an order you agree to this agreement. Last updated: 19 August 2026.</p>
<h2>1. The service</h2>
<p>BookNow is an intermediary. We display offers from airlines, hotels, insurers, and connectivity partners and help you pay and manage orders. The transport, stay, cover, or connectivity contract is between you and the supplier named on the booking confirmation.</p>
<h2>2. Eligibility</h2>
...
<p>Airline fare rules, hotel cancellation windows, insurance cooling-off rights, and eSIM activation rules are set by the supplier. BookNow processes change and refund requests according to those rules and any BookNow service fee shown at checkout. Refunds return to the original payment method or wallet when the supplier allows it, and may take several business days after the supplier approves.</p>
<h2>6. Documents and check-in</h2>
<p>You must complete check-in, visa, health, and entry requirements. BookNow does not guarantee boarding, hotel check-in, cover payment, or network registration if a supplier or authority refuses service.</p>
<h2>7. Acceptable use</h2>
<p>You may not scrape the app, interfere with other users, submit false bookings, or use BookNow to test stolen payment instruments. We may cancel orders and withhold unused credit where we reasonably suspect fraud.</p>
<h2>8. Liability</h2>
<p>BookNow is not liable for delays, schedule changes, overbooking, property standards, medical outcomes, or network coverage of suppliers. Our liability for the BookNow platform itself is limited to the BookNow service fees you paid for the affected order, except where liability cannot be limited by law (including death or personal injury caused by negligence, or fraud).</p>
<h2>9. Intellectual property</h2>
<p>The BookNow name, logos, and app content belong to BookNow or its licensors. You receive a limited licence to use the app for personal booking purposes.</p>
<h2>10. Governing law</h2>
<p>These terms are governed by the laws of the country in which BookNow is established, without affecting mandatory consumer protections in your country of residence. If a clause is unenforceable, the rest remains in force.</p>
<h2>11. Contact</h2>
<p>For complaints about a BookNow order, use in-app support and include the order number. Supplier issues (lost baggage, room complaints, claim files, SIM activation) should also be raised with the named supplier.</p>
HTML;
    }
...
<p>تنظّم هذه البنود استخدامك لتطبيق وموقع BookNow. بإنشاء حساب أو تقديم طلب فإنك توافق على هذه الاتفاقية. آخر تحديث: 19 أغسطس 2026.</p>
<h2>1. طبيعة الخدمة</h2>
<p>BookNow وسيط. نعرض عروضاً من شركات الطيران والفنادق والتأمين والاتصال ونساعدك على الدفع وإدارة الطلبات. عقد النقل أو الإقامة أو التغطية أو الاتصال يكون بينك وبين المزوّد المذكور في تأكيد الحجز.</p>
<h2>2. الأهلية</h2>
...
<p>قواعد أجرة الطيران ونوافذ إلغاء الفندق وحقوق التراجع عن التأمين وقواعد تفعيل eSIM يحدّدها المزوّد. تعالج BookNow طلبات التعديل والاسترداد وفق تلك القواعد وأي رسم خدمة لـ BookNow يظهر عند الدفع. يعود المبلغ إلى وسيلة الدفع الأصلية أو المحفظة عندما يسمح المزوّد، وقد يستغرق عدة أيام عمل بعد موافقة المزوّد.</p>
<h2>6. الوثائق وإجراءات السفر</h2>
<p>يجب استكمال إجراءات تسجيل الوصول والتأشيرة والصحة ومتطلبات الدخول. لا تضمن BookNow الصعود للطائرة أو دخول الفندق أو صرف التغطية أو تسجيل الشبكة إذا رفض المزوّد أو الجهة الرسمية الخدمة.</p>
<h2>7. الاستخدام المقبول</h2>
<p>لا يجوز استخراج بيانات التطبيق آلياً، أو الإضرار بالمستخدمين، أو تقديم حجوزات وهمية، أو استخدام BookNow لتجربة وسائل دفع مسروقة. يجوز إلغاء الطلبات وحجز الرصيد غير المستخدم عند الاشتباه المعقول بالاحتيال.</p>
<h2>8. المسؤولية</h2>
<p>لا تتحمل BookNow تأخير الرحلات أو تغيّر الجدول أو الحجز الزائد أو مستوى المنشأة أو النتائج الطبية أو تغطية الشبكة لدى المزوّدين. تقتصر مسؤولية منصة BookNow على رسوم خدمة BookNow المدفوعة للطلب المتأثر، باستثناء ما لا يجوز تحديده قانوناً (بما في ذلك الوفاة أو الإصابة الناتجة عن إهمال، أو الاحتيال).</p>
<h2>9. الملكية الفكرية</h2>
<p>اسم BookNow والشعارات ومحتوى التطبيق ملك لـ BookNow أو المرخّصين. تحصل على ترخيص محدود لاستخدام التطبيق لأغراض الحجز الشخصي.</p>
<h2>10. القانون الواجب التطبيق</h2>
<p>تخضع هذه البنود لقانون الدولة التي تأسست فيها BookNow، دون المساس بالحماية الإلزامية للمستهلك في بلد إقامتك. إذا بطل بند تبقى بقية البنود سارية.</p>
<h2>11. التواصل</h2>
<p>للشكاوى المتعلقة بطلب BookNow استخدم الدعم داخل التطبيق مع رقم الطلب. مسائل المزوّد (أمتعة، شكوى غرفة، ملف مطالبة، تفعيل الشريحة) تُرفع أيضاً إلى المزوّد المذكور.</p>
HTML;
    }
...
<p>This policy applies to flight orders placed through BookNow. Airline fare rules for the selected offer remain binding and are shown beside this text at checkout.</p>
<h2>1. The offer</h2>
...
<p>Voluntary changes, no-show, and refunds follow the airline fare rules (including non-refundable and non-changeable tickets). BookNow forwards your request to the supplier and adds any BookNow handling fee displayed before you confirm.</p>
<h2>5. Schedule changes and disruption</h2>
<p>If the airline changes time, routing, or cancels a sector, your rights are those granted by the airline and applicable passenger regulations. BookNow will surface the update in the order and notifications when the supplier sends it.</p>
<h2>6. Baggage and extras</h2>
<p>Included bags are those listed on the offer. Extra bags, seats, and meals bought later may be priced by the airline at check-in and are not always available via BookNow.</p>
...
<p>تنطبق هذه السياسة على طلبات الطيران عبر BookNow. تبقى قواعد أجرة الناقل للعرض المختار ملزمة وتظهر بجانب هذا النص عند إتمام الحجز.</p>
<h2>1. العرض</h2>
...
<p>التعديل الاختياري وعدم الحضور والاسترداد تخضع لقواعد أجرة الناقل (بما في ذلك التذاكر غير القابلة للاسترداد أو التعديل). تُمرّر BookNow طلبك إلى المزوّد وتضيف أي رسم معالجة يظهر قبل التأكيد.</p>
<h2>5. تغيّر الجدول والاضطراب</h2>
<p>إذا غيّرت الشركة الوقت أو المسار أو ألغت قطاعاً، فحقوقك هي ما يمنحه الناقل وأنظمة حماية المسافر المعمول بها. تعرض BookNow التحديث في الطلب والإشعارات عندما يصل من المزوّد.</p>
<h2>6. الأمتعة والإضافات</h2>
<p>الحقائب المشمولة هي المذكورة في العرض. الحقائب الإضافية والمقاعد والوجبات التي تُشترى لاحقاً قد يسعرها الناقل عند تسجيل الوصول وقد لا تتوفر دائماً عبر BookNow.</p>
<h2>7. وثائق السفر</h2>
...
<p>This policy applies to hotel orders placed through BookNow. Property rules (check-in age, extras, and cancellation window) for the selected rate remain binding.</p>
<h2>1. The rate</h2>
...
<h2>2. Guest names</h2>
<p>The lead guest must match the name on the booking and present a valid ID at the desk. Additional guests must not exceed the occupancy of the __BookNowD__ room.</p>
...
<p>Free cancellation applies only inside the window printed on the rate. After that deadline, or in case of no-show, the property may charge the first night or the full stay as stated on the offer. BookNow cannot override a non-refundable rate.</p>
...
<p>Minibar, parking, resort fees, and damage deposits are usually collected by the hotel. Disputes about the room or billing at the property should be raised with the hotel and then with BookNow support with your order number.</p>
<h2>7. Force majeure</h2>
<p>If the hotel cannot honour the reservation (overbooking or closure), the supplier must offer an alternative or a refund under its rules. BookNow will help you claim that remedy.</p>
HTML;
    }
...
<p>تنطبق هذه السياسة على طلبات الفنادق عبر BookNow. تبقى قواعد المنشأة (عمر تسجيل الوصول والإضافات ونافذة الإلغاء) الخاصة بالسعر المختار ملزمة.</p>
<h2>1. السعر</h2>
...
<p>الإلغاء المجاني يسري فقط داخل النافذة المطبوعة على السعر. بعد ذلك الموعد أو في حال عدم الحضور قد يحصّل الفندق ليلة أولى أو كامل الإقامة كما هو مذكور في العرض. لا تستطيع BookNow تجاوز سعر غير قابل للاسترداد.</p>
...
<p>الميني بار وموقف السيارات ورسوم المنتجع وتأمين التلفيات غالباً يحصّلها الفندق. نزاعات الغرفة أو الفاتورة في المنشأة تُرفع للفندق ثم لدعم BookNow مع رقم الطلب.</p>
<h2>7. الظروف القاهرة</h2>
<p>إذا تعذّر على الفندق الوفاء بالحجز (حجز زائد أو إغلاق) فعلى المزوّد تقديم بديل أو استرداد وفق قواعده. تساعدكم BookNow في المطالبة بذلك.</p>
HTML;
    }
...
<p>This policy describes how BookNow sells travel cover. The insurer’s wording, exclusions, and claim process for the selected plan remain binding and are shown with the plan.</p>
<h2>1. Intermediary role</h2>
<p>BookNow distributes plans from licensed insurers or underwriting partners. The insurance contract is between you and the insurer named on the certificate.</p>
...
<p>If the insurer offers a cooling-off period and no claim has been made, you may cancel through BookNow within that window. After travel has started, unused premium is usually non-refundable unless the insurer’s wording says otherwise.</p>
<h2>5. Claims</h2>
<p>File claims with the insurer using the contacts on the certificate. Keep invoices, medical reports, and delay confirmations. BookNow can share your order reference but does not decide claim outcomes.</p>
<h2>6. Limits</h2>
...
HTML;
    ...
    public static function insuranceAr(): string
    {
        return <<<'HTML'
<h1>سياسة التأمين</h1>
<p>تصف هذه السياسة كيف تبيع BookNow تغطية السفر. يبقى نص شركة التأمين والاستثناءات وإجراءات المطالبة الخاصة بالخطة المختارة ملزماً ويظهر مع الخطة.</p>
<h2>1. دور الوسيط</h2>
<p>توزّع BookNow خططاً من شركات تأمين مرخّصة أو شركاء اكتتاب. عقد التأمين بينك وبين الشركة المذكورة على الشهادة.</p>
...
<p>إذا منحت الشركة فترة تراجع ولم تُقدَّم مطالبة، يمكنك الإلغاء عبر BookNow داخل تلك النافذة. بعد بدء السفر غالباً لا يُرد القسط غير المستخدم إلا إذا نصّت الوثيقة على غير ذلك.</p>
<h2>5. المطالبات</h2>
<p>قدّم المطالبة لشركة التأمين عبر بيانات التواصل على الشهادة. احتفظ بالفواتير والتقارير الطبية وإثباتات التأخير. تستطيع BookNow مشاركة رقم الطلب ولا تقرر نتيجة المطالبة.</p>
<h2>6. الحدود</h2>
...
HTML;
    ...
    public static function esimEn(): string
    {
        return <<<'HTML'
<h1>eSIM policy</h1>
<p>This policy applies to eSIM data plans bought through BookNow. The connectivity provider’s fair-use and coverage map for the selected plan remain binding.</p>
<h2>1. Compatibility</h2>
<p>Your device must be eSIM-capable and carrier-unlocked. BookNow is not responsible if the device rejects the profile or if the local network requires a physical SIM.</p>
<h2>2. Delivery</h2>
...
<h2>5. Refunds</h2>
<p>If the QR was never redeemed and the provider allows a refund window, BookNow will request a refund. After successful installation or first use, data plans are generally non-refundable except where the profile cannot be attached for a proven provider fault.</p>
...
HTML;
    ...
    public static function esimAr(): string
    {
        return <<<'HTML'
<h1>سياسة eSIM</h1>
<p>تنطبق هذه السياسة على باقات بيانات eSIM المشتراة عبر BookNow. تبقى سياسة الاستخدام العادل وخريطة التغطية الخاصة بالخطة المختارة ملزمة.</p>
<h2>1. التوافق</h2>
<p>يجب أن يدعم جهازك eSIM وأن يكون غير مقفول على شبكة معيّنة. لا تتحمل BookNow رفض الجهاز للملف الشخصي أو إذا كانت الشبكة المحلية تتطلب شريحة فعلية.</p>
<h2>2. التسليم</h2>
...
<h2>5. الاسترداد</h2>
<p>إذا لم يُستخدم رمز QR وسمح المزوّد بنافذة استرداد، تطلب BookNow الاسترداد. بعد التثبيت الناجح أو أول استخدام غالباً لا تُرد الباقة إلا إذا تعذّر ربط الملف بسبب عطل مثبت لدى المزوّد.</p>
