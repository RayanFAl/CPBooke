...
final class NotificationActionCatalog
{
    ...
    public static function templates(): array
    {
        ...
        return [
            ...
            self::t('WALLET_TOPUP_SUCCESS', 'Wallet top-up success', NotificationTemplateCategories::PAYMENTS, 'Wallet credited.', '{amount} {currency} added to your wallet', 'Your Booke wallet was credited with {amount} {currency}.', 'تمت إضافة رصيد للمحفظة', 'تمت إضافة {amount} {currency} إلى محفظتك.', [NotificationChannels::PUSH, NotificationChannels::IN_APP], $amount),
            ...
            self::t('WALLET_LOW_BALANCE', 'Wallet low balance', NotificationTemplateCategories::PAYMENTS, 'Wallet balance is low.', 'Your wallet balance is low', 'Your Booke wallet balance is {amount} {currency}.', 'رصيد المحفظة منخفض', 'رصيد محفظتك {amount} {currency}.', [NotificationChannels::PUSH, NotificationChannels::IN_APP], $amount),
            ...
            self::t('POINTS_REDEEMED', 'Loyalty points redeemed', NotificationTemplateCategories::LOYALTY, 'Points were redeemed.', 'You redeemed {points} points', '{points} points were redeemed from your Booke account.', 'تم استخدام النقاط', 'تم استخدام {points} نقطة.', [NotificationChannels::PUSH, NotificationChannels::IN_APP], ['user_name', 'points', 'deep_link']),
            self::t('REWARD_AVAILABLE', 'Loyalty reward available', NotificationTemplateCategories::LOYALTY, 'A reward can be claimed.', 'A reward is waiting', 'You can claim your next Booke reward.', 'مكافأة متاحة', 'يمكنك المطالبة بمكافأتك التالية.', [NotificationChannels::PUSH, NotificationChannels::IN_APP], ['user_name', 'deep_link']),
            ...
            self::t('EMAIL_CHANGED', 'Email changed', NotificationTemplateCategories::SECURITY, 'Account email changed.', 'Your email was updated', 'The email on your Booke account was changed.', 'تم تغيير البريد', 'تم تحديث البريد الإلكتروني لحسابك.', [NotificationChannels::PUSH, NotificationChannels::IN_APP, NotificationChannels::EMAIL], ['user_name', 'deep_link']),
            self::t('PHONE_CHANGED', 'Phone changed', NotificationTemplateCategories::SECURITY, 'Account phone changed.', 'Your phone number was updated', 'The phone number on your Booke account was changed.', 'تم تغيير رقم الهاتف', 'تم تحديث رقم هاتف حسابك.', [NotificationChannels::PUSH, NotificationChannels::IN_APP, NotificationChannels::EMAIL], ['user_name', 'deep_link']),
