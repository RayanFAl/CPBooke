...
class RbacRegistry
{
    ...
    public static function permissions(): array
    {
        return [
            ...
            self::permission('users.update', 'users', 'update', 'Update users', 'Edit user profiles, customer identity, and assigned roles.'),
            self::permission('orders.view', 'orders', 'view', 'View orders', 'Access the orders module.'),
            self::permission('orders.create', 'orders', 'create', 'Create manual bookings', 'Record a booking on behalf of a customer from the Control Panel.'),
            ...
            self::permission('customer-wallets.view', 'customer_wallets', 'view', 'View customer wallets', 'Access customer wallet balances and transaction history.'),
            self::permission('customer-wallets.manage', 'customer_wallets', 'manage', 'Manage customer wallets', 'Credit, debit, freeze, and unfreeze customer wallets.'),
            ...
            self::permission('suppliers.api-config.manage', 'suppliers', 'manage_api_config', 'Manage provider API configuration', 'Create and update provider API credentials, services, and connection tests.'),
            self::permission('suppliers.credentials.view', 'suppliers', 'view_credentials', 'View provider credentials', 'Access masked provider credential fields with audit logging.'),
            ...
            self::permission('settlements.reopen', 'settlements', 'reopen', 'Reopen settlements', 'Reopen a closed provider settlement period with a required reason and audit trail.'),
    ...
    public static function rolePermissions(): array
    {
        return [
            ...
            self::ROLE_ADMIN => [
                ...
                'customer-wallets.manage',
                'suppliers.view',
                'suppliers.manage',
                'suppliers.api-config.manage',
                'suppliers.credentials.view',
                'approvals.view',
                'approvals.approve',
                'settlements.view',
                'settlements.manage',
