...
{
    /**
     * Conservative spend-based loyalty: lower discounts, smoother tier thresholds, VIP at 25k.
     */
    public function up(): void
    {
        ...
        $tierDefinitions = [
            1 => [
                ...
                'badge_label' => 'Level 1',
                'color_token' => 'cyan',
                'description' => 'Spend 1,000 in the current month to unlock 5% off for 5 months.',
                'sort_order' => 1,
            ],
            2 => [
                'code' => 'level_2',
                ...
                'badge_label' => 'Level 2',
                'color_token' => 'amber',
                'description' => 'Spend 5,000 in the current month to unlock 8% off for 9 months.',
                'sort_order' => 2,
            ],
            3 => [
                'code' => 'level_3',
                ...
                'badge_label' => 'Level 3',
                'color_token' => 'violet',
                'description' => 'Spend 15,000 in the current month to unlock 12% off for 12 months.',
                'sort_order' => 3,
            ],
            4 => [
                'code' => 'vip',
                ...
                'badge_label' => 'VIP',
                'color_token' => 'rose',
                'description' => 'Spend 25,000 in the current month to unlock 15% off for 12 months.',
                'sort_order' => 4,
            ],
        ];
        ...
        $ruleDefinitions = [
            1 => ['name' => 'Level 1 monthly spend target', 'min_period_spend' => 1000, 'benefit_duration_months' => 5],
            2 => ['name' => 'Level 2 monthly spend target', 'min_period_spend' => 5000, 'benefit_duration_months' => 9],
            3 => ['name' => 'Level 3 monthly spend target', 'min_period_spend' => 15000, 'benefit_duration_months' => 12],
            4 => ['name' => 'VIP monthly spend target', 'min_period_spend' => 25000, 'benefit_duration_months' => 12],
        ];
        ...
        if (Schema::hasTable('loyalty_benefits')) {
            ...
            $benefitDefinitions = [
                1 => ['code' => 'level_1_discount', 'name' => 'Level 1 discount', 'value' => 5],
                2 => ['code' => 'level_2_discount', 'name' => 'Level 2 discount', 'value' => 8],
                3 => ['code' => 'level_3_discount', 'name' => 'Level 3 discount', 'value' => 12],
                4 => ['code' => 'vip_discount', 'name' => 'VIP discount', 'value' => 15],
            ];
