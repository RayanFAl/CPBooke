...
const fallbackLabel = computed(() => props.flight?.provider_name || props.providerName || t('Not available'));
</script>

<template>
    <div v-if="flight?.pnr || routeLabel || airlineCode || flight?.airline" class="flex min-w-[10rem] items-start gap-2">
