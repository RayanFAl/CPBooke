...
use App\Modules\Admin\Support\Http\Controllers\SupportReportsController;
use Illuminate\Support\Facades\Route;

Route::get('/support/reports', [SupportReportsController::class, 'index'])
    ->middleware('permission:support.view')
    ->name('support.reports.index');

Route::get('/support/reports/export.csv', [SupportReportsController::class, 'exportCsv'])
    ->middleware('permission:support.view')
    ->name('support.reports.export.csv');
...
Route::post('/support/{supportTicket}/order/partial-refund', [SupportController::class, 'partialRefund'])
    ->middleware('permission:support.partial-refund')
...
Route::post('/support/{supportTicket}/order/reverse-refund', [SupportController::class, 'reverseRefund'])
    ->middleware('permission:finance.reverse-refund')
...
Route::get('/support/{supportTicket}/resolution-report/print', [ResolutionReportController::class, 'print'])
    ->middleware('permission:support.view')
    ->name('support.resolution-report.print');
